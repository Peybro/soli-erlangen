      ...
      <div className="d-flex justify-content-center p-2">
        ...
        {!showCalendar && (
          <Alert variant="danger">
            <p>
              Um die Termine zu sehen, musst du den Google Kalender aktivieren.
            </p>
            <p>
              Das kannst du rechts unten mit einem Klick auf "Einstellungen"
              machen.
            </p>
            <br />
            <p>
              Wenn du nicht möchtest, dass Google Cookies speichert, dann kannst
              du diese Seite auch in einem privaten Fenster öffnen, oder den
              Cookie selbst wieder löschen.
            </p>
          </Alert>
        )}
      </div>
